...
mod_ndocd = cal_modularity(get_graph_info("data/amazon/amazon-transformed.txt"), coms2)
# mod_base = cal_modularity(get_graph_info("data/amazon/amazon-transformed.txt"), get_communities_list2("data/amazon/communities", " "))
