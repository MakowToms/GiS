...
import numpy as np
from NDOCD.load_data import write_communities_to_file, get_NBA_graph
...
ndocd.JS_threshold = 0.35
ndocd.MD_threshold = 0.35
...
mod_ndocd = cal_modularity(get_graph_info("data/NBA Graph/Edges-transformed.txt"), coms2)
